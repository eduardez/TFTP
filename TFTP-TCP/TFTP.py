...
#   -struct
#   -os
#   -ntpath: Debido a que la libreria OS puede
#   fallar al devolver la ruta del  archivo he
#   usado esta otra libreria.
#   -hashlib: Usada para comprobar que los
#   archivos origen y destino sean el mismo
##################################################
...
def request_packet(type, filename):
    ...
    if type == 'read':
        ...
        return error_packet(chr(4), 'Illegal TFTP operation')
